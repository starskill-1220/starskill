...
<div class="page-headbox">
  <div class="page-headtextbox">
    <p class="page-headline page-privacy__headtext">Privacy Policy</p>
    <p class="page-description">プライバシーポリシーについて</p>
  </div>
</div>

<div class="content-box">
  <div class="container">
    <p class="page-privacy__body">STARSKILL（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>

    <p class="page-privacy__title">第1条（個人情報）</p>
    <p class="page-privacy__body">「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，生年月日，住所，電話番号，連絡先その他の記述等により特定の個人を識別できる情報及び容貌，指紋，声紋にかかるデータ，及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。</p>

    <p class="page-privacy__title">第2条（個人情報の収集方法）</p>
    <p class="page-privacy__body">当社は，ユーザーが利用登録をする際に氏名，生年月日，住所，電話番号，メールアドレス，銀行口座番号，クレジットカード番号，運転免許証番号などの個人情報をお尋ねすることがあります。また，ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,当社の提携先（情報提供元，広告主，広告配信先などを含みます。以下，｢提携先｣といいます。）などから収集することがあります。</p>


    <p class="page-privacy__title">第3条（個人情報を収集・利用する目的）</p>
    <p class="page-privacy__body">当社が個人情報を収集・利用する目的は，以下のとおりです。<br>
...
<p class="page-privacy__title">第4条（利用目的の変更）</p>
<p class="page-privacy__body">1.当社は，利用目的が変更前と関連性を有すると合理的に認められる場合に限り，個人情報の利用目的を変更するものとします。<br>
2.利用目的の変更を行った場合には，変更後の目的について，当社所定の方法により，ユーザーに通知し，または本ウェブサイト上に公表するものとします。</p>


<p class="page-privacy__title">第5条（個人情報の第三者提供）</p>
<p class="page-privacy__body">
1,当社は，次に掲げる場合を除いて，あらかじめユーザーの同意を得ることなく，第三者に個人情報を提供することはありません。ただし，個人情報保護法その他の法令で認められる場合を除きます。<br><br>
...
<p class="page-privacy__title">第6条（個人情報の開示）</p>
<p class="page-privacy__body">
...
<p class="page-privacy__title">第7条（個人情報の訂正および削除）</p>
<p class="page-privacy__body">
...
<p class="page-privacy__title">第8条（個人情報の利用停止等）</p>
<p class="page-privacy__body">
...
<p class="page-privacy__title">第9条（プライバシーポリシーの変更）</p>
<p class="page-privacy__body">
...
<p class="page-privacy__title">第10条（お問い合わせ窓口）</p>
<p class="page-privacy__body">本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。
<br><br>
住所：東京都東村山市本町3-13-24 102<br>
社名：STARSKILL<br>
代表者：河上 勇人<br>
Eメールアドレス：contact@star-skill.jp<br>
<br>
以上</p>
  </div>
</div>
